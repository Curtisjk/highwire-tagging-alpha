<?php
	...
	if(!isset($_GET['uid'])){
		//no uid, redirect
		header("Location: /iss/taggingstudy/");
	} else {
		$id = $_GET['uid'];
	}
?>
...
<div class="navbar-inner">
	<div class="container-fluid">
		...
		<div class="nav-collapse collapse">
			<ul class="nav">
				<li><a class="signup-link" href="/iss/taggingstudy/">Project Home</a></li>
			</ul>
			<!-- /nav -->
		</div>
		<!-- /nav-collapse -->
...
<div class="main-content">
	<div class="container-fluid">
		<h1 id="video" style="padding-top: 100px; margin-top: -100px;">Video</h1>
		<div align="center">
		<iframe width='640' height='420' src='http://www.vuact.com/v/demo-lancaster-uni/sir-ken-robinsondo-schools-kill-creativity' frameborder='0' allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>
		</div>
	</div>
</div>
