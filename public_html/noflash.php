...
<div class="main-content">
	<div class="container-fluid">
		...
		<p>It looks like you do not have flash installed on your computer. In order to take part in this study we require that you have <a href="http://www.adobe.com/go/getflashplayer" target="_blank" border="0">Adobe Flash Player</a> installed in order to watch the videos.</p>

		<p>Once you have installed Flash Player, <a href="<?=SITE_HOME?>">click here</a> to start again.</p>

		<p><a href="http://www.adobe.com/go/getflashplayer" target="_blank" border="0"><img src = "http://www.adobe.com/macromedia/style_guide/images/160x41_Get_Flash_Player.jpg" alt="Get Adobe Flash Player"/></a></p>
	</div>
</div>
